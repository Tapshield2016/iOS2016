...
public extension Array {
    ...
    private var indexesInterval: HalfOpenInterval<Int> { return HalfOpenInterval<Int>(0, count) }
    ...
    */
    ...
    /**
        Checks if test returns true for any element of 
    ...
    */
    ...
    /**
        Returns an array containing the first n elements of 
    ...
    */
    ...
    /**
        Returns an array containing the the last n elements of 
    ...
    func permutation (length: Int) -> [[Element]] {
        if length < 0 || length > count {
            ...
            for combination in combinations {
                ...
                permutations += permutationHelper(length, array: &mutableCombination, endArray: &endArray)
            }
            return permutations
        }
    }
    ...
    */
    func combination (length: Int) -> [[Element]] {
        ...
        var combinations: [[Element]] = []
        let offset = count - indexes.count
        while true {
            var combination: [Element] = []
            for index in indexes {
                combination.append(self[index])
    ...
    */
    func repeatedPermutation(length: Int) -> [[Element]] {
        ...
        permutationIndexes.repeatedPermutationHelper([], length: length, arrayLength: count, permutationIndexes: &permutationIndexes)
    ...
    private func repeatedPermutationHelper(seed: [Int], length: Int, arrayLength: Int, inout permutationIndexes: [[Int]]) {
        ...
        for i in (0..<arrayLength) {
            ...
            newSeed.append(i)
            repeatedPermutationHelper(newSeed, length: length, arrayLength: arrayLength, permutationIndexes: &permutationIndexes)
        }
    }
    ...
    */
    ...
    /**
        reduce with initial value first()
    */
    ...
    */
    ...
    /**
        reduceRight with initial value last()
    */
    ...
    */
    func sortUsing <U:Comparable> (block: ((Element) -> U)) -> [Element] {
        return sort({ block($0.0) < block($0.1) })
    }
    ...
    */
    ...
    /**
        Inserts an array at a given index in 
    ...
    */
    ...
    /**
        Returns a subarray whose items are in the given interval in 
...
public extension Array {
    ...
    func flattenedArrayForKey(key: String) -> [AnyObject] {
        ...
        for item in self {
            ...
            } else if let item = item as? NSObject where item.respondsToSelector(NSSelectorFromString(key)) {
