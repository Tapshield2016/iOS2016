...
public extension Double {
    ...
    */
     ...
     */
    func roundToDecimal(decimals: Double) -> Double {
        
        let tenpow = pow(10, decimals)
        
        return (tenpow * self).round() / tenpow;
    }
...
extension Double {
    ...
    public func format(minimumIntegerDigits: Int = 0, fractionDigits: Int = 0) -> String {
        ...
        if let formatted = formatter.stringFromNumber(self) {
            return formatted
        }
