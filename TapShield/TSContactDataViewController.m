...
#import "TSContactDataViewController.h"
#import "TSContactDataTableViewController.h"

@interface TSContactDataViewController ()

@property (strong, nonatomic) TSContactDataTableViewController *tableViewController;

@end

@implementation TSContactDataViewController
...
- (void)viewWillDisappear:(BOOL)animated {
    ...
    _userProfile.addressDictionary = [_tableViewController fullAddressDictionary];
}
